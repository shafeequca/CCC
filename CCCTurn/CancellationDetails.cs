...
namespace CCCTurn
{
    public partial class CancellationDetails : Form
    {
        ...
        {
            string query = "select ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS Sl_No,convert(varchar, o.Odate,105) as Order_Date,o.Party_Name,r.Location as Destination,v.Vehicle_Number,o.Vehicle_Type,o.Order_Type,o.Rate,o.commission,c.Reason  from Orders o inner join Rate r on r.rateid=o.rateid INNER JOIN Vehicles v on v.vehicleid=o.vehicleid inner join OrderCancellation c on c.oid=o.oid where oDate>='" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "' and oDate<='" + dateTimePicker2.Value.ToString("yyyy-MM-dd") + "'";
            ...
            try
            {
                ...
                ds.Tables["Cancellation"].Clear();
                ds.Tables["Cancellation"].Merge(dt);
        ...
        private void CancellationDetails_Load(object sender, EventArgs e)
        {
            ds = new DataSet1();
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(System.IO.Path.GetDirectoryName(Application.ExecutablePath).ToString() + @"\Reports\rptCancellationDetails.rpt");
